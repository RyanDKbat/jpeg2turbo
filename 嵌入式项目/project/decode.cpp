...
int main()
{
    ...
    FILE* red_fw = fopen("/home/nvidia/project/transport/red_encode.txt", "r");
    for (i = 0; i < 250000; i++)
    {
        fscanf(red_fw, "%lf", &dataA[i]);
    }
    fclose(red_fw);
    FILE* green_fw = fopen("/home/nvidia/project/transport/green_encode.txt", "r");
    for (i = 0; i < 250000; i++)
    {
        fscanf(green_fw, "%lf", &dataB[i]);
    }
    fclose(green_fw);
    FILE* blue_fw = fopen("/home/nvidia/project/transport/blue_encode.txt", "r");
    for (i = 0; i < 250000; i++)
    {
